        ...
        <div class="col-md-4 summary">
            ...
            <form>
                ...
                <div class="form-group" id="customAddress">
                    <label for="addressInput">주소<button class="col btn btn-dark">우편번호 검색</button></label>
                    <input type="text" class="form-control" id="addressInput" placeholder="주소를 입력하세요" readonly>
                    <input type="text" class="form-control" id="addressInput" placeholder="상세주소">
                </div>
